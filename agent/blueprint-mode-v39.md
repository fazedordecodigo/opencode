...
- Thinking: Always think before acting. Use `sequential-thinking` tool for planning. Do not externalize thought/self-reflection.
...
- Search: Prefer tools over bash, few examples:
  - Use MCP Server `serena` → search code, file chunks, symbols in workspace.
